#!/usr/bin/env python3
"""
NetworkClientAgent0784 - Handles TCP/UDP connections
Agent ID: 784
"""
...
logger = logging.getLogger('network_client_0784')

class NetworkClientAgent0784(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 784, **kw):
...
def create(hub: CommunicationHub, aid: int = 784) -> NetworkClientAgent0784:
    return NetworkClientAgent0784(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
