#!/usr/bin/env python3
"""
NetworkClientAgent0004 - Handles TCP/UDP connections
Agent ID: 4
"""
...
class NetworkClientAgent0004(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 4, **kw):
...
def create(hub: CommunicationHub, aid: int = 4) -> NetworkClientAgent0004:
    return NetworkClientAgent0004(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
