#!/usr/bin/env python3
"""
NetworkClientAgent0104 - Handles TCP/UDP connections
Agent ID: 104
"""
...
logger = logging.getLogger('network_client_0104')

class NetworkClientAgent0104(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 104, **kw):
...
def create(hub: CommunicationHub, aid: int = 104) -> NetworkClientAgent0104:
    return NetworkClientAgent0104(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
