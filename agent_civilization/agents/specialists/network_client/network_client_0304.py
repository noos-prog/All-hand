#!/usr/bin/env python3
"""
NetworkClientAgent0304 - Handles TCP/UDP connections
Agent ID: 304
"""
...
logger = logging.getLogger('network_client_0304')

class NetworkClientAgent0304(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 304, **kw):
...
def create(hub: CommunicationHub, aid: int = 304) -> NetworkClientAgent0304:
    return NetworkClientAgent0304(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
