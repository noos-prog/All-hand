#!/usr/bin/env python3
"""
NetworkClientAgent0964 - Handles TCP/UDP connections
Agent ID: 964
"""
...
logger = logging.getLogger('network_client_0964')

class NetworkClientAgent0964(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 964, **kw):
...
def create(hub: CommunicationHub, aid: int = 964) -> NetworkClientAgent0964:
    return NetworkClientAgent0964(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
