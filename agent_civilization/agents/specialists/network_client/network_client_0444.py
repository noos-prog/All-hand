#!/usr/bin/env python3
"""
NetworkClientAgent0444 - Handles TCP/UDP connections
Agent ID: 444
"""
...
logger = logging.getLogger('network_client_0444')

class NetworkClientAgent0444(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 444, **kw):
...
def create(hub: CommunicationHub, aid: int = 444) -> NetworkClientAgent0444:
    return NetworkClientAgent0444(name="network_client_"+f"{aid:04d}", hub=hub, agent_id=aid)
