#!/usr/bin/env python3
"""
EducatorAgent0370 - Creates learning materials
Agent ID: 370
"""
...
class EducatorAgent0370(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 370, **kw):
...
def create(hub: CommunicationHub, aid: int = 370) -> EducatorAgent0370:
    return EducatorAgent0370(name="educator_"+f"{aid:04d}", hub=hub, agent_id=aid)
