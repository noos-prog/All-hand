#!/usr/bin/env python3
"""
EducatorAgent0750 - Creates learning materials
Agent ID: 750
"""
...
class EducatorAgent0750(BaseAgent):
    def __init__(self, name: str, hub: CommunicationHub, agent_id: int = 750, **kw):
...
def create(hub: CommunicationHub, aid: int = 750) -> EducatorAgent0750:
    return EducatorAgent0750(name="educator_"+f"{aid:04d}", hub=hub, agent_id=aid)
